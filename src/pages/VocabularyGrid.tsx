...
export default function VocabularyGrid({ onNavigate, darkMode }: VocabGridProps) {
  ...
  return (<>
    <div className="flex-1 min-h-0 overflow-y-auto scroll-area">
      ...
      <div className="pattern-geo relative overflow-hidden p-5 pt-8">
      ...
      {/* ── Stats ── */}
      <div className="bg-primary-subtle p-4 flex items-center gap-3">
      ...
      <div className="px-4 pt-2 mb-6">
        ...
        {[
          ...
          { icon:<Heart size={20} className="text-primary" />, l:"お気に入り", d:`收藏的单词 · ${getFavoriteCount()} 語`, a:()=>onNavigate("favorites") },
