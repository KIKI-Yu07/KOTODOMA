  ...
  return (
    <div className="fixed inset-0 z-[999] flex flex-col bg-bg" style={{position:"fixed",top:0,left:0,right:0,bottom:0}}>
      ...
      <main key={current} className="page-enter mx-auto w-full max-w-xl flex-1 px-3 pb-32 pt-[16px]">
        ...
        </div>:<div className="mt-4 border-l-2 border-main pl-4">{question.reading&&<p className="font-mono text-xs tracking-wide text-hint">{question.reading}</p>}<p className="mt-0.5 text-[38px] font-medium leading-tight tracking-tight text-main">{question.subject}</p></div>}
